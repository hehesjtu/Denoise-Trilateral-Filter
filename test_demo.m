...
VR1 = load(strcat('./train',num2str(blocksize),'/rationality_right1.mat'));  VR2 = load(strcat('./train',num2str(blocksize),'/rationality_right2.mat'));
VL1 = load(strcat('./train',num2str(blocksize),'/rationality_left1.mat'));   VL2 = load(strcat('./train',num2str(blocksize),'/rationality_left2.mat'));
vl1 = VL1.rationality_box;  vl2 = VL2.rationality_box; vr1 = VR1.rationality_box;  vr2 = VR2.rationality_box; 
...
for num = 3: numFrames-2
    ...
    toc
    imwrite(uint8(imgpre_denoise),strcat('./denoise_results/frame',num2str(num),'_denoise_01.png'));
